...
##define cell
cell = Cell("SWG_TE0_REFLECTION_Total_300nm")
##define layer
wg_layer = Layer(1, 0)
...
#MWBG parameters:
widthBusWaveguide= 3
lengthBusWaveguide = 10
lengthGrating = 4010
heightPerturbationSquare = 1.5
periodPerturbationSquare = 0.2357
gapBetweenBusWaveguideAndPerturbation = -1.5
apodizationIndex = 0
...
text = Text(text_start_point,"SWG_TE0_REFLECTION_Total_300nm")
text.draw(cell,wg_layer)

for k in range (11):
    periodPerturbationSquare = 0.2357 + (k-5)*0.002
    numberPerturbation = int(lengthGrating / periodPerturbationSquare)
    y_shift = k*50
...
make_gdsii_file("SWG_TE0_REFLECTION_Total_300nm.gds")
